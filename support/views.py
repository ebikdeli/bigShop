...
class FAQListView(ListView):
    ...
    template_name = 'support/templates/support/faq_list.html'
...
class ContactUsCreateView(CreateView):
    ...
    template_name = 'support/templates/support/contact_us_form.html'
    success_url = reverse_lazy('support:contact_thanks')
...
class ContactUsRedirectView(TemplateView):
    ...
    template_name = 'support/templates/support/contact_us_thanks.html'


class AboutUsView(TemplateView):
    """Template View to show 'About Us' page to users. It's content defined in 'constance' settings in 'base' module."""
    template_name = 'support/templates/support/about_us.html'
